...
export class Replay {
    ...
    header_json(pretty) {
        ...
        let deferred1_1;
        try {
            const ret = wasm.replay_header_json(this.__wbg_ptr, pretty);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    full_json(pretty) {
        const ret = wasm.replay_full_json(this.__wbg_ptr, pretty);
     ...
     */
    network_err() {
        const ret = wasm.replay_network_err(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rl_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
